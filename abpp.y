...
while_stmt: WHILE expression COLON non_if_stmt ;
for_stmt: FOR for_dec SEMICOLON expression SEMICOLON assignment COLON non_if_stmt | FOR SEMICOLON expression SEMICOLON assignment COLON non_if_stmt ;
